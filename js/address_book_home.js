...
const createInnerHtml = () => {
    ...
    for (const contact of addressBookContactList){
        ...
        <tr>
            ...
            <td>
                <img id="${contact.id}" class="delete-icon" onclick="remove(this)" alt="delete" src="../assets/delete-black-18dp.svg">
                <img id="${contact.id}" class="edit-icon" alt="edit" onclick="update(this)" src="../assets/create-black-18dp.svg">
            </td>
        </tr>`;
    }
